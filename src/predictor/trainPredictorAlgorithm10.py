...
TRAINING .7 rushing yards per game .3 receiving yards per game
...
def getSimilarity(player1, player2):
	...
	similarity = (.7 * (rushYpGSim)) + (.3 * (airYpGSim))
...
#    k9["name"] = "k9"
    ...
    print("RESULTS FROM ALGORITHM 10: .7 * Rushing YpG + .3 * Receiving YpG")
