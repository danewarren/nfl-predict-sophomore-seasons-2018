...
De'Angelo Henderson:  ONLY YARDS PER GAME
...
'''
def getRookieDeAngeloHenderson():
	data = {}
	data["ID"] = 9588
	data["gamesPlayed"] = 5
	data["rushing_attempts"] = 7
	data["rushing_yards"] = 13
	data["rushing_touchdowns"] = 0
	data["receiving_targets"] = 2
	data["receiving_receptions"] = 2
	data["receiving_yards"] = 36
...
def main():
    ...
    rookie = getRookieDeAngeloHenderson() 
    ...
    print("De'Angelo Henderson: 9/100 touches")
