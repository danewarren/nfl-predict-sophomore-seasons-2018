...
'''
def getRookieJoeMixon():
	data = {}
	data["ID"] = 15528
	data["gamesPlayed"] = 14
	data["rushing_attempts"] = 178
	data["rushing_yards"] = 626
	data["rushing_touchdowns"] = 4
	data["receiving_targets"] = 34
	data["receiving_receptions"] = 30
	data["receiving_yards"] = 287
