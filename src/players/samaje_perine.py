...
Samaje Perine:  ONLY YARDS PER GAME
...
'''
def getRookieSamajePerine():
	data = {}
	data["ID"] = 17370
	data["gamesPlayed"] = 16
	data["rushing_attempts"] = 175
	data["rushing_yards"] = 603
	data["rushing_touchdowns"] = 1
	data["receiving_targets"] = 24
	data["receiving_receptions"] = 22
	data["receiving_yards"] = 182
