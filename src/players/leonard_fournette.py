...
Leonard Fournette:  ONLY YARDS PER GAME
...
'''
def getRookieLeonardFournette():
	data = {}
	data["ID"] = 7203
	data["gamesPlayed"] = 13
	data["rushing_attempts"] = 268
	data["rushing_yards"] = 1040
	data["rushing_touchdowns"] = 9
	data["receiving_targets"] = 48
	data["receiving_receptions"] = 36
	data["receiving_yards"] = 302
	data["receiving_touchdowns"] = 1
...
def main():
    ...
    rookie = getRookieLeonardFournette() 
