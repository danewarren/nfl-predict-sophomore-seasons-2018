...
Marlon Mack:  ONLY YARDS PER GAME
...
'''
def getRookieMarlonMack():
	data = {}
	data["ID"] = 13799
	data["gamesPlayed"] = 14
	data["rushing_attempts"] = 93
	data["rushing_yards"] = 358
	data["rushing_touchdowns"] = 3
	data["receiving_targets"] = 33
	data["receiving_receptions"] = 21
	data["receiving_yards"] = 225
