...
Devante Mays:  ONLY YARDS PER GAME
...
'''
def getRookieDevanteMays():
	data = {}
	data["ID"] = 14406
	data["gamesPlayed"] = 8
	data["rushing_attempts"] = 4
	data["rushing_yards"] = 1
	data["rushing_touchdowns"] = 0
	data["receiving_targets"] = 3
	data["receiving_receptions"] = 3
...
def main():
    ...
    print("Devante Mays: 7/100 touches")
