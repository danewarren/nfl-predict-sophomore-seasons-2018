...
D'Onta Foreman:  ONLY YARDS PER GAME
...
'''
def getRookieDOntaForeman():
	data = {}
	data["ID"] = 7144
	data["gamesPlayed"] = 10
	data["rushing_attempts"] = 78
	data["rushing_yards"] = 327
	data["rushing_touchdowns"] = 2
	data["receiving_targets"] = 8
	data["receiving_receptions"] = 6
	data["receiving_yards"] = 83
...
def main():
    ...
    print("D'Onta Foreman: 84/100 touches")
