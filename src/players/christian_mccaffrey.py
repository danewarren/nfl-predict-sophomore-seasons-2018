...
CHRISTIAN MCCAFFREY:  ONLY YARDS PER GAME
...
'''
def getRookieChristianMcCaffrey():
	data = {}
	data["ID"] = 14460
	data["gamesPlayed"] = 16
	data["rushing_attempts"] = 117
	data["rushing_yards"] = 435
	data["rushing_touchdowns"] = 2
	data["receiving_targets"] = 113
	data["receiving_receptions"] = 80
	data["receiving_yards"] = 651
...
def main():
    ...
    rookie = getRookieChristianMcCaffrey() 
