...
Jamaal Williams:  ONLY YARDS PER GAME
...
'''
def getRookieJamaalWilliams():
	data = {}
	data["ID"] = 24100
	data["gamesPlayed"] = 16
	data["rushing_attempts"] = 153
	data["rushing_yards"] = 556
	data["rushing_touchdowns"] = 4
	data["receiving_targets"] = 34
	data["receiving_receptions"] = 25
	data["receiving_yards"] = 262
	data["receiving_touchdowns"] = 2
...
def main():
    ...
    rookie = getRookieJamaalWilliams() 
