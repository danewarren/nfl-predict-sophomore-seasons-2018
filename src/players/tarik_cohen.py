...
Tarik Cohen:  ONLY YARDS PER GAME
...
'''
def getRookieTarikCohen():
	data = {}
	data["ID"] = 4185
	data["gamesPlayed"] = 16
	data["rushing_attempts"] = 87
	data["rushing_yards"] = 370
	data["rushing_touchdowns"] = 2
	data["receiving_targets"] = 71
	data["receiving_receptions"] = 53
	data["receiving_yards"] = 353
