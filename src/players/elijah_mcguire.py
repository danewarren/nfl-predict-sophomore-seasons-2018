...
Elijah McGuire:  ONLY YARDS PER GAME
...
'''
def getRookieElijahMcGuire():
	data = {}
	data["ID"] = 14819
	data["gamesPlayed"] = 16
	data["rushing_attempts"] = 88
	data["rushing_yards"] = 315
	data["rushing_touchdowns"] = 1
	data["receiving_targets"] = 26
	data["receiving_receptions"] = 17
	data["receiving_yards"] = 117
