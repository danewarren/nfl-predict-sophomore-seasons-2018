...
BRIAN HILL:  ONLY YARDS PER GAME
...
'''
def getRookieBrianHill():
	data = {}
	data["ID"] = 9824
	data["gamesPlayed"] = 7
	data["rushing_attempts"] = 11
	data["rushing_yards"] = 37
...
def main():
    ...
    print("Brian Hill: 13/100 touches")
