...
Kareem Hunt:  ONLY YARDS PER GAME
...
'''
def getRookieKareemHunt():
	data = {}
	data["ID"] = 10496
	data["gamesPlayed"] = 16
	data["rushing_attempts"] = 272
	data["rushing_yards"] = 1327
	data["rushing_touchdowns"] = 8
	data["receiving_targets"] = 63
	data["receiving_receptions"] = 53
	data["receiving_yards"] = 455
	data["receiving_touchdowns"] = 3
