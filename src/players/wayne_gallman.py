...
Wayne Gallman:  ONLY YARDS PER GAME
...
'''
def getRookieWayneGallman():
	data = {}
	data["ID"] = 7545
	data["gamesPlayed"] = 13
	data["rushing_attempts"] = 111
	data["rushing_yards"] = 476
	data["rushing_touchdowns"] = 0
	data["receiving_targets"] = 48
	data["receiving_receptions"] = 34
	data["receiving_yards"] = 193
