...
CHRIS CARSON:  ONLY YARDS PER GAME
...
'''
def getRookieChrisCarson():
	data = {}
	data["ID"] = 3536
	data["gamesPlayed"] = 4
	data["rushing_attempts"] = 49
	data["rushing_yards"] = 208
	data["rushing_touchdowns"] = 0
	data["receiving_targets"] = 8
	data["receiving_receptions"] = 7
	data["receiving_yards"] = 59
...
def main():
    ...
    print("Chris Carson: 56/100 touches")
