...
AARON JONES:  ONLY YARDS PER GAME
...
def getRookieAaronJones():
	...
	data["ID"] = 11487
	data["gamesPlayed"] = 12
	data["rushing_attempts"] = 81
	data["rushing_yards"] = 448
	data["rushing_touchdowns"] = 4
	data["receiving_targets"] = 18
	data["receiving_receptions"] = 9
	data["receiving_yards"] = 22
...
def main():
    ...
    print("Aaron Jones: 90/100 touches")
