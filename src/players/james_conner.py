...
James Conner:  ONLY YARDS PER GAME
...
'''
def getRookieJamesConner():
	data = {}
	data["ID"] = 4418
	data["gamesPlayed"] = 14
	data["rushing_attempts"] = 32
	data["rushing_yards"] = 144
	data["rushing_touchdowns"] = 0
	data["receiving_targets"] = 1
...
def main():
    ...
    print("James Conner: 32/100 touches")
